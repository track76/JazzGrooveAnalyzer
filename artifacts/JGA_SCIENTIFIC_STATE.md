...
## Historical scientific recovery — 2026-09-20 (superseded above)

**Next question / milestone — `JGA-BASS-DRUM-MICROTIMING-001`:** among defensibly observable same-quarter Bass and generic-Drum events in Ray Brown Trio — “Exactly Like You,” what is the measured `t_DRUM − t_BASS` relationship in milliseconds? The [current scientific state](../docs/JGA_SCIENTIFIC_STATE.md) and [session closure](../docs/scientific/rfc/JGA_SESSION_CLOSURE_OBSERVABLE_GROOVE_20260920/README.md) govern. Positive offset means Drum after Bass. Use the original audio for earliest defensible source-associated attack markers, retain uncertainty/grade, and abstain where unknown.

Frozen: 496 Bass and 500 generic-Drum HIGH+MEDIUM candidates (inventory freeze `a76c0533d5e3e7e7572a593cfc2b762fa5bf418ea13cf3e69425afbc74fd34e6`); initial 164.76 BPM and median local 164.09 BPM quarter candidate (grid freeze `18e5d3283f9de9b878fbfe4e956805717e86a55da91a9c7c2494ca595cf0941d`); 127 same-slot opportunities, 118 single-candidate and nine ambiguous, none yet performer timing. PI manual tap ~162 BPM for this track is approximate; ~120 BPM belongs to “Easy Does It.” Automatic phase result PARTIALLY_SUPPORTED; later PI listening confirmed quarter pulse through 01:55–02:10 despite transient reduced Bass/Drum audibility of unknown cause. Possible triplets remain subdivisions. No universal recognition, new model/training, Gallegati/Virtual Tap development, Rubner/Yamaha, or source separation. The generated layer/milestone fields below are a historical software snapshot.
...
Historical Metadata Milestone

M90

Phase II Scientific Validation

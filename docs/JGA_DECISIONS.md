...
## Historical product authority pointer — 2026-09-20 (superseded above)

The active JGA v1 observable-groove product path is governed by the [PI finalization directive](scientific/rfc/JGA_FINALIZATION_DIRECTIVE_001_20260920/README.md), [session closure](scientific/rfc/JGA_SESSION_CLOSURE_OBSERVABLE_GROOVE_20260920/README.md), and [active architecture overview](JGA_ARCHITECTURE.md). **Next milestone: JGA-BASS-DRUM-MICROTIMING-001.** This pointer does not revise any LOCKED decision below; historical/general workflows must be read against the newer PI-authorized excerpt-based original-full-mix product scope.

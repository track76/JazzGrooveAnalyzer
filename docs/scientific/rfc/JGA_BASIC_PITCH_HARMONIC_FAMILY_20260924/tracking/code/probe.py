...
Path('/Users/StarTrack/Development/JazzGrooveAnalyzer/docs/scientific/rfc/JGA_BASIC_PITCH_HARMONIC_FAMILY_20260924/tracking/output/ISOLATION_PROBE.json').write_text(json.dumps({'denied':res,'passed':True}))
print('ISOLATION PROBE PASS',len(res))

try:
 open('/Users/StarTrack/Development/JazzGrooveAnalyzer/docs/scientific/rfc/JGA_BASIC_PITCH_HARMONIC_FAMILY_20260924/crosscheck/input/bass_native.json', 'rb').read(1)

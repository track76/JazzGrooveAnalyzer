...
It is not a note, raw onset, transient, generic musical-event transcription, or estimation of pulse, beat or tempo.
...
- estimates pulse;
- estimates tempo;
- creates the reconstructed movement to which it refers;
...
An EME is a Domain representation supported by preserved observations.

It never represents an estimated temporal reference or a raw observation.

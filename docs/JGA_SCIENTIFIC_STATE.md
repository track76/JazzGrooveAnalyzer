...
The preserved scientific checkpoint below retains the original whole-track findings and all earlier measurement limits. [Parent result freeze](scientific/rfc/JGA_WHOLE_TRACK_GROOVE_FROZEN_PIPELINE_001_20260921/JGA_WHOLE_TRACK_GROOVE_RESULT_FREEZE.json) remains `6ec8af738bb2512859ef92d29c5a36c6d0557dea009ee1c9d86cca543a5382dc`.
...
# Current scientific checkpoint — 2026-09-21

PROJECT: Jazz Groove Analyzer (JGA). Branch: `scientific/translation-layer-finalization`. HEAD: `93e851c5efce233c5c7dfe7c75f28f96ef0f97db`.

CURRENT PHASE: whole-track frozen groove-analysis validation completed, status **PASS**, awaiting PI review. No commit or push. No next study is authorized for automatic execution.

## Frozen authorities

- [Whole-track procedure](scientific/rfc/JGA_WHOLE_TRACK_GROOVE_FROZEN_PIPELINE_001_20260921/JGA_WHOLE_TRACK_GROOVE_PROCEDURE_FREEZE.json), SHA-256 `1f34654b693ef01af2b93348d3ffcff05e9c93d60eaa82fa3583d0911e17fd2a`.
- [Whole-track scientific result freeze](scientific/rfc/JGA_WHOLE_TRACK_GROOVE_FROZEN_PIPELINE_001_20260921/JGA_WHOLE_TRACK_GROOVE_RESULT_FREEZE.json), SHA-256 `6ec8af738bb2512859ef92d29c5a36c6d0557dea009ee1c9d86cca543a5382dc`.
- [Measured result](scientific/rfc/JGA_WHOLE_TRACK_GROOVE_FROZEN_PIPELINE_001_20260921/RESULT.md).
- [Analyzability boundary](scientific/rfc/JGA_FISHMAN_PRIMARY_BASS_ONSET_REFERENCE_001_20260921/JGA_ANALYZABILITY_BOUNDARY_20260921.md).

## Current research architecture and timing ownership

FULL MIX → JGA-native observability → modular external source-identity evidence → JGA frozen internal pulse/quarter grid → JGA-native marker-to-quarter geometry → groove analysis.

JGA owns timestamps, frozen grid, stored BPM and JGA_NATIVE_EVENT_TO_QUARTER_MS. ADTOF supplies qualified Drum identity evidence; MuScriptor Medium supplies complementary Bass/Drum evidence. YourMT3 is historical/comparator evidence, not the mandatory Drum admission gate in this research procedure. Production runtime behavior has NOT been changed.

States: DRUM_SUPPORTED, BASS_SUPPORTED, BASS_AND_DRUM_SUPPORTED, CONFLICTING_EVIDENCE, UNKNOWN. Dual support is one native marker with two source hypotheses, not two independently timed physical attacks. Missing identity never deletes an observed event.

## Actual whole-track result

Acoustic domain 0–342.656870748299 s; terminal exact zeros excluded. 1627 native candidates; 52 complete 6.5 s windows; final remainder retained separately. Source counts: {"DRUM_SUPPORTED": 898, "BASS_SUPPORTED": 9, "BASS_AND_DRUM_SUPPORTED": 198, "CONFLICTING_EVIDENCE": 0, "UNKNOWN": 522}. Percentages: {"DRUM_SUPPORTED": 55.194, "BASS_SUPPORTED": 0.553, "BASS_AND_DRUM_SUPPORTED": 12.17, "CONFLICTING_EVIDENCE": 0.0, "UNKNOWN": 32.084}.

Window half-shift distribution: {"N": 52, "min": -223.38607285479, "max": 183.50368608655498, "median": -2.9203830971599984, "IQR": 63.040320030753506, "negative": 27, "positive": 25}. Window slope distribution: {"N": 52, "min": -44.49707351516816, "max": 28.66262097169509, "median": -1.5680270496904978, "IQR": 15.058539601241865, "negative": 29, "positive": 23}. These are native marker geometry, not performer timing.

Frozen scientific conclusions: {"chronologically_varying_geometry": "YES-WITH-QUALIFICATION", "reference_pattern_nonoverlap_recurrence": "PARTIALLY", "reducible_to_BPM_alone": "NO-NOT-SUPPORTED", "source_supported_all_event_compatibility": "YES", "frozen_procedure_generalizes": "YES-WITH-QUALIFICATION"}. See the result for associations, sensitivity, missing evidence and limitations. Whole-track procedural generalization is not cross-recording validation or physical attack accuracy.

## Measurement status

ESTABLISHED / USABLE: frozen internal BPM/quarters according to their authority; native observability and preserved candidate coverage; direct native marker-to-quarter arithmetic. Whole-track descriptive geometry is usable with the qualifications in the frozen result.

PROMISING / QUALIFIED: ADTOF Drum identity (small positive/negative control evidence), MuScriptor complementary identity, provisional whole-track source states, source-supported geometry; JGA Drum attack timing PROMISING; controlled Fishman Bass T0 PROMISING. BPM associations are descriptive and do not establish causality or statistical independence.

NOT YET ESTABLISHED: full-mix physical Bass attack timing; independent physical Bass-versus-Drum microtiming; universal identity accuracy; generalization beyond this recording.

PROHIBITED: performer-specific early/late or intentional acceleration claims from native markers; treating dual symbols as physical simultaneity; external timing as JGA timing; sample spacing as attack accuracy; absence of candidates as instrumental silence.

## Controlled Double Bass — preserved findings

3/4 Mario Gallegati (2009), 104 cm scale, Pirastro Obligato Orchestra, E-A-D-G, A4=440 Hz. Fishman Full Circle is the primary operational bridge-coupled witness, NOT physical Ground Truth. DPA 4099 and RØDE NT5 are separate airborne/body-response witnesses; do not force consensus.

12 retained events; Fishman bounded in both reviews 11, overlap11/11, disjoint0; 11 usable T0 intersections, widths2.00–5.01 ms, median3.01 ms, maximum5.01 ms. Decision FISHMAN OPERATIONAL T0 PROMISING. Widths do NOT establish equivalent physical timing accuracy. Earlier multichannel robustness did not establish reproducible Bass attack timing; DPA/NT5 ordering was inconsistent. Real-music Bass transfer remains unresolved and is not authorized here.

## Preserved bounded results

Reference122–128.5 s:32 native events; BPM163.744–164.939, median164.505. First/second-half native offset medians−13.26/−63.50 ms, IQR68.04/105.26 ms, shift−50.24 ms; slope−11.64 ms/s, leave-one-out−13.52 to−11.32; Drum-inclusive−6.45→−51.42 ms; BPM–offset rho−0.014. Measurable geometry change, not physical anticipation or causal BPM effect.

Local115–130 s:69 candidates, original32 reproduced32/32, additional37:10 Drum-supported,15 dual,12 UNKNOWN,0 Bass-only/conflicts. W01(115.011–121.511):N27,shift−6.52,slope−6.38,Drum+30.02→+19.53. W02(121.511–128.011):N31,shift−54.17,slope−11.88,Drum−3.60→−51.42. Reference:N32,shift−50.24,slope−11.64,Drum−6.45→−51.42. W02 shares28 events with reference and is NOT independent replication; local recurrence was only PARTIAL.

## Next primary scientific phase

**WHOLE-TRACK GROOVE TRAJECTORY VALIDATION** — Validate the frozen pulse/phase and marker-geometry trajectory in predefined passages, including nearest-quarter wrap and coverage effects, before stronger musicological or cross-recording claims.

Recommendation only. STOP for PI review; do not execute the next phase without PI authorization.
...
## Historical scientific question — observable groove, 2026-09-20 (superseded above)

**Among defensibly observable same-quarter Bass and generic-Drum events, what is the measured Drum−Bass temporal relationship in milliseconds?** This is the next bounded question, `JGA-BASS-DRUM-MICROTIMING-001`, under the [PI finalization directive](scientific/rfc/JGA_FINALIZATION_DIRECTIVE_001_20260920/README.md). Analyze the observable and abstain elsewhere; full-recording universal source recognition is unnecessary.

Current evidence is frozen: independent inventory (496 Bass, 500 generic Drum HIGH+MEDIUM; SHA-256 `a76c0533d5e3e7e7572a593cfc2b762fa5bf418ea13cf3e69425afbc74fd34e6`), adaptive grid (164.76 BPM initial, 164.09 BPM median local; freeze SHA-256 `18e5d3283f9de9b878fbfe4e956805717e86a55da91a9c7c2494ca595cf0941d`), and 127 exploratory same-quarter opportunities (118 single-candidate, nine ambiguous). PI manual tap for “Exactly Like You” is ~162 BPM approximate, distinct from ~120 BPM for “Easy Does It.” Automatic local phase audit remains PARTIALLY_SUPPORTED; PI listening confirms the perceived quarter through 01:55–02:10 despite reduced acoustic support. The cause of the dynamic attenuation is unknown. Possible triplets are subdivisions, not a new pulse. Bar downbeat and physical Bass–Drum attack offsets remain unresolved.

For the next task retain `t_DRUM − t_BASS` (positive Drum after Bass), inspect earliest defensible source-associated attack markers on original audio, and preserve uncertainty and evidence grade. Do not infer timing from late Bass fundamental maxima or early Drum spectral maxima. No new model search/training, Gallegati/Virtual Tap development, Rubner/Yamaha, source separation, or universal drum-recognition work. The older scientific-layer snapshot below remains historical.
...
## Preserved PI listening context

[Confessin listening annotations](scientific/PI_CONFESSIN_LISTENING_CONTEXT_20260921.md); expert context, not numerical timing Ground Truth.

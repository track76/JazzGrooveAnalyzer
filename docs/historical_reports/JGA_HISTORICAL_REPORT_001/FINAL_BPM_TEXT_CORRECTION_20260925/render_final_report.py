...
dis=rows(A/'FINAL_ANCHORED_BMIG_DMIG.csv');ev=rows(A/'EVENT_PROVENANCE_127.csv')
...
with PdfPages(mem) as pdf:
 ...
 fig.text(.07,.939,'BPM interno medio: 164,5 · Variazione BPM: +6,8 BPM · Contrabbasso–Batteria: mediana +8,9 ms, Bass dietro',fontsize=7)
 ...
 pdf.savefig(fig);fig.savefig('/private/tmp/jga_bpm_corrected_page1.png',dpi=200);plt.close(fig)
 fig=plt.figure(figsize=(210/25.4,297/25.4))
 ...
 pdf.savefig(fig);fig.savefig('/private/tmp/jga_bpm_corrected_page2.png',dpi=200);plt.close(fig)

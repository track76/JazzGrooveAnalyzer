...
The PI-adopted final M33–M48 report is [JGA_FINAL_REPORT.pdf](FINAL_OBSERVED_RELATION_CLEANUP_20260925/JGA_FINAL_REPORT.pdf); [freeze record](FINAL_OBSERVED_RELATION_CLEANUP_20260925/FREEZE_RECORD.json). Earlier report versions below remain historical evidence and are not overwritten.

...
## Ordered future research

1. Close and freeze current Tempo Authority evidence (this documentation phase).
2. Develop and validate a bounded Tempo-Existence / Confidence Gate.
3. Develop and validate Metric-Level Selection + Metric Lock / Continuity.
4. Freeze the final JGA musical-quarter authority.
5. Resume/integrate SOURCE IDENTITY.
6. Execute separately authorized JGA-ATTACK-REFINEMENT-001 for Double Bass / Ride / Hi-Hat.
7. Validate instrument attack timestamps independently from the quarter grid.
8. Compute instrument attack ↔ frozen quarter microtiming.
9. Validate Bass ↔ Ride and Bass ↔ Hi-Hat temporal relationships.
10. Only then authorize new-generation groove/musicological analysis.
...
Completed: first complete form-linked descriptive analysis of the current recording, including macro/micro form, source/coverage summaries and frozen candidate-loss reaggregation. Isolated final-theme contrast remains unresolved. Keep cross-recording generalization, whole-track perceptual pulse qualification, Drum timing strengthening and precise Bass timing unresolved; do not mark them solved. Basic research coordinate remains closed with qualification; no redesign is planned.
...
## Completed investigations and open questions

Completed to recorded qualification: native autonomous observability investigation; external identity benchmark; ADTOF Bass-leakage negative controls; blind source-exposure validation; modular evidence adapter; dual-source witness audit; source-associated Drum timing pilot (PROMISING); controlled Bass reference/re-review/Fishman investigation (PROMISING, not physical accuracy); first bounded groove analysis; local115–130 comparison; whole-track frozen study as recorded above.

OPEN: robust full-mix Bass attack estimator; independent physical Bass–Drum microtiming; Fishman T0 and Drum timing strengthening; cross-track/cross-recording validation; generalization beyond this recording; relevant timbre/source-identity uncertainty. Completed investigations do not mean all identity/timing questions are solved.
...
## Historical milestone — observable-groove closure, 2026-09-20 (superseded above)

**JGA-BASS-DRUM-MICROTIMING-001** is the next bounded task under the [PI finalization directive](scientific/rfc/JGA_FINALIZATION_DIRECTIVE_001_20260920/README.md). The [session closure](scientific/rfc/JGA_SESSION_CLOSURE_OBSERVABLE_GROOVE_20260920/README.md) records frozen Bass and generic-Drum inventories, the unmodified quarter grid, exploratory same-slot opportunities, and PI listening confirmation of the quarter pulse in 01:55–02:10 of “Exactly Like You.” Next, on separate PI authorization, measure only defensibly observable same-quarter Bass↔generic-Drum attacks on original audio and report Drum−Bass milliseconds, listening examples, scatter graphics, and corpus data. Ride/Hi-Hat classification and universal full-recording recognition are not blockers. Do not reopen failed research branches or automatically launch new model work. The former “next milestone” below is historical.

## Historical directive-adoption checkpoint — 2026-09-20

**COMPLETE JGA v1 AS AN OBSERVABLE GROOVE ANALYZER.** See the [frozen finalization directive](scientific/rfc/JGA_FINALIZATION_DIRECTIVE_001_20260920/README.md) and its [ten completion gates](scientific/rfc/JGA_FINALIZATION_DIRECTIVE_001_20260920/JGA_V1_DEFINITION_OF_DONE.md). The current path admits reliable excerpts, localizes observed attacks on original audio, pairs corresponding Bass/Ride/Hi-Hat events conservatively, and exports signed millisecond offsets, musical reports, listening examples, scatter graphics and corpus data. The 2026-09-10 priority below is historical. Next milestone: JGA-OBSERVABLE-GROOVE-ANALYSIS-001 on “Exactly Like You”; no universal source-recognition or open-ended model search gate.

## Historical scientific priority — 2026-09-10 consolidated checkpoint

...
Current scientific roadmap: [Official Roadmap](JGA_ROADMAP.md), [observable-groove session closure](scientific/rfc/JGA_SESSION_CLOSURE_OBSERVABLE_GROOVE_20260920/README.md), and [next-session target](scientific/rfc/JGA_SESSION_CLOSURE_OBSERVABLE_GROOVE_20260920/NEXT_SESSION_TARGET.md). **Current next milestone: JGA-BASS-DRUM-MICROTIMING-001.** The [2026-09-10 timing checkpoint](scientific/JGA_TIMING_CHECKPOINT_20260910.md) and phase list below are historical, not the current research frontier.
...
Automatic Groove Classification

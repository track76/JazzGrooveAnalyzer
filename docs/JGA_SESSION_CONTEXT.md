...
Use only observable events and abstain elsewhere. Bass and generic-Drum inventories remain independent until same-quarter correspondence; no Ride/Hi-Hat identity or bar downbeat is required. No new model search, training, Gallegati/Virtual Tap development, Rubner/Yamaha access, source separation, or universal recognition detour. No Bass–Drum millisecond result has yet been established.

## Historical Session — 2026-08-02

...
JGA_RUN = BASE / "run_20260824_112305"
TRACKER_RUN = BASE / "external_beat_benchmark_20260824_164758"
RUN = BASE / "external_beat_jga_geometry_20260824_170946"
PREREG = BASE / "preregistrations/H-CEDVAL005-EXTERNAL-BEAT-TO-JGA-DRUMS-GEOMETRY-01.md"
STUDY_ID = "H-CEDVAL005-EXTERNAL-BEAT-TO-JGA-DRUMS-GEOMETRY-01"
EXECUTION_ID = "EXEC-CEDVAL005-EXTERNAL-BEAT-JGA-GEOMETRY-20260824-170946"
JGA_EXECUTION_ID = "EXEC-CEDVAL005-REAL-AUDIO-20260824-112305"
JGA_FINGERPRINT = "074d84768f508e6ceee9c9225c34e9ea881ce50d88e0d5f930525b92e87bd9d6"
TRACKER_EXECUTION_ID = "EXEC-CEDVAL005-EXTERNAL-BEAT-BENCHMARK-20260824-164758"
TRACKER_FINGERPRINT = "accf7ae656178cb04fb798795658b7d4f6e2bd5a7616f47755d7579435100e38"
SR, HOP = 44100, 512
INPUT_HASHES = {
    "jga_eme": "81e45700196b7f712237da5ac6bbb32324a3f782bb66022e2427b08d9e342f2d",
    "essentia": "b630ba72957c2fa6ec2e67e825cc17ceb3a9c4a27a75743e08a39658ae21443d",
    "librosa": "1ab3bed4271746300ce50d92d82cbd0a532d47ff74598b89c212b88e3010c926",
    "preregistration": "1c3778c198cb28454dcfa5520fd642b85a1b99229a290453fa194b3e87d5f1c9",
}
PATHS = {
...
def verify_authorities() -> tuple[list[dict], dict, dict]:
    ...
    if len(drums) != 907 or len(essentia["native_outputs"]["ticks"]["seconds"]) != 468 or len(librosa["native_outputs"]["beat_frames"]["values"]) != 464:
...
def analyze_tracker(tracker: str, beats: list[dict], drum_times: list[Fraction], groups: dict[Fraction, list[dict]]) -> dict:
    ...
    content = {
        ...
        "jga_epistemic_status": "FRAME_RESOLVED_JGA_OBSERVATION",
...
def derive() -> dict:
    ...
    content = {
        "schema": "JGA-CEDVAL005-EXTERNAL-BEAT-TO-JGA-DRUMS-GEOMETRY/v1",
        "study_id": STUDY_ID,
        "execution_id": EXECUTION_ID,
        "preregistration_commit": "744ff8a1dc34b00a8a15f3a4845d51f4c97e1e0e",
        "authorities": {
            "jga_execution_id": JGA_EXECUTION_ID,
            "jga_scientific_fingerprint": JGA_FINGERPRINT,
            "jga_drums_eme_count": 907,
            "external_execution_id": TRACKER_EXECUTION_ID,
            "external_combined_fingerprint": TRACKER_FINGERPRINT,
            "input_sha256": INPUT_HASHES,
        },
        "coordinate_authority": "EXACT_ABSOLUTE_DISTRIBUTED_FILE_TIME",
        "analyses": analyses,
        "future_five_window_visualization_only": [
            ["W1", 896557, 1117057], ["W2", 2910171, 3130671],
            ["W3", 4923786, 5144286], ["W4", 6937400, 7157900],
            ["W5", 8951014, 9171514],
        ],
        "firewalls": {
...
def freeze(pass_one: Path, pass_two: Path) -> None:
    ...
    report = [
        ...
        "Status: **PASS_FROZEN_NEUTRAL_EXTERNAL_BEAT_TO_JGA_DRUMS_GEOMETRY**", "",
        "The two frozen external beat populations were independently localized against the frozen 907-event JGA Drums EME population using exact distributed-file-time geometry. Two fresh-process derivations reproduced byte-identical scientific content.", "",

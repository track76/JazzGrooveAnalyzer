"""Freeze CED-VAL-003-SWING-3-4 CalibrationSymbolicEvent authority only."""
...
SOURCE = Path("/Volumes/SSD Track/JGA/datasets/CED-VAL-003-SWING/symbolic/CED-VAL-003-SWING-3-4.musicxml")
SOURCE_SHA256 = "f74856b2766db824536bdbab0b3ab62dbcf8460c780272b88df13dec8620f4c2"
OUTPUT = Path("validation/CED-VAL-003-SWING-3-4/run_20260823_203324/calibration_symbolic_events.json")
PARTS = {"P1": "Piano", "P3": "Double Bass", "P4": "Drums"}
EXPECTED = {"Drums": 155, "Double Bass": 100, "Piano": 57}
...
def main() -> None:
    ...
    if not per_minutes or set(per_minutes) != {Fraction(140)} or set(beat_units) != {"quarter"}:
